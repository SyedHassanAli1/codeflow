      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        {/*
          **ADJUSTMENT MADE HERE:**
          Removed 'hidden' and set the default (mobile) layout to a flex column
          The sm:grid and larger grid classes then take over for larger screens.
        */}
        <div className="flex flex-col sm:grid sm:grid-cols-3 lg:grid-cols-6 gap-8 sm:gap-8 lg:gap-12 mb-8 sm:mb-12">
          
          {/* Logo, Description, and Socials Section */}
          <div className="col-span-1 sm:col-span-3 lg:col-span-2 text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-3 sm:space-x-4">
              {/* Social links are fine, no changes needed here */}
              <a
                href="#"
          ...
          <div className="sm:col-span-3 lg:col-span-4">
            ...
            {/* **ADJUSTMENT MADE HERE:**
              Changed default grid-cols for mobile to grid-cols-2.
              This stacks the four link categories (Product, Company, etc.) into two columns.
            */}
        ...
        {/* Bottom Bar: Copyright and Legal Links (This section was already visible and responsive) */}
